...
function addConfirmMsg() {
  const confirmMsgElement = document.querySelector('.js-confirm-msg');
  confirmMsgElement.innerHTML = `<div class="js-set">
      Are you sure you want to reset the score?
      <button class="confirm-yes-button js-yes-button">Yes</button>
      <button class="confirm-no-button js-no-button">No</button>
    </div>`;
